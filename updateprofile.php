...
border-top: 1px solid #7C7A7A;
            ...
            <?php
				...
				$mysqli = "SELECT * from student_info where sid='{$studentid}'";
                $result3 = mysqli_query($con,$mysqli) or die("cannot execute query");
                ...
                <thead>
                 ...
                 <tbody>
                    ...
                    <tr class="info">
                        ...
                        <td></td>
                        <td>
                            <button style="float:right" type="submit" class="btn btn-action">Submit</button>
                        </td>
                    </tr>
                    </form>
                </tbody>
